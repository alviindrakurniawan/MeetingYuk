...
class DetailPlaceMerchant extends GetView<EditPlaceViewModel> {
  const DetailPlaceMerchant({Key? key}) : super(key: key);
                  ...
                  child: CarouselSlider.builder(
                    ...
                    itemBuilder: (context, int itemIndex, int pageViewIndex) {
                      return ClipRRect(
                        ...
                        // Border radius
                        child: Image.network(
                            controller.detailPlace.value!.rooms[indexPage]
                                .imageUrls[itemIndex],
                            fit: BoxFit
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      buildFacilitiesPopUp(controller
                          .detailPlace.value!.rooms[indexPage].facilities)
                    ],
                  ),
                ),
              ...
              [
                ...
                Container(
                    ...
                    child: CustomFilledButton(
                      ...
                      borderRad: 5,
                      onPressed: () {
                        controller.setEditPlace();
                        Get.toNamed('/editplace-merchant');
                      },
                    )),
                //Operational Hours
                Container(
                              ...
                              children: [
                                ...
                                MarkerLayer(
                                  markers: [
                                    Marker(
                                        point: LatLng(
                                            controller.detailPlace.value!.location
                                                .latitude,
                                            controller.detailPlace.value!.location
                                                .longitude),
                        ...
                        CarouselSlider.builder(
                            ...
                            itemBuilder: (BuildContext context, int itemIndex,
                                  ...
                                  CardRoomMerchant(
                                    ...
                                    editTap: () async{
                                      await controller.setEditRoom();
                                      Get.toNamed('/editroom-merchant');
                                    },
                                  ),
                                ),
                      ),
