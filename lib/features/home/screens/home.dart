    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            //   GestureDetector(
            //     onTap: () {},
            //     child: Image.asset('assets/icons/chat28.png',
            //       height: 28,
            //       width: 28,),
            //   ),
            //   // IconButton(
        ...
        body: ListView(
          ...
          children: [
                        ...
                        return CardCafeDistance(
                          ...
                          onTap: () async {
                            final detailPlace = await controller.getDetailPlace(
                                controller.nearMeList[index].id!);
            ...
            Obx(() => controller.loadingPrevious.value == true
                                ...
                                onTap: () async {
                                  final detailPlace =
                                      await controller.getDetailPlace(controller
                                          .reservationHistoryList[index].id);
                                  Get.toNamed('/detailplace',
                                      arguments: {'detailPlace': detailPlace});
                                },
                              );
            ...
            //   height: 285,
            //   child: Obx(() {
            //     if (controller.loadingPrevious.value) {
            //       return Center(child: CircularProgressIndicator());
            //     } else {
            //       if (controller.reservationHistoryList.isEmpty) {
            //         return Container();
            //       } else {
            //         return GridView.builder(
            //             scrollDirection: Axis.horizontal,
            ...
            //                 mainAxisSpacing: 10,
            //                 childAspectRatio: 255 / 165),
            //             itemCount: controller.reservationHistoryList.length < 6
            //                 ? controller.reservationHistoryList.length
            //                 : 6,
            //             itemBuilder: (BuildContext context, index) {
            //               return CafeCardRecom(
            ...
            //                     .reservationHistoryList[index].startAt,
            //                 endAt:
            //                 controller.reservationHistoryList[index].endAt,
            //                 totalPrice: controller
            //                     .reservationHistoryList[index].totalPrice,
            //                 onTap: () async {
            //                   final detailPlace =
